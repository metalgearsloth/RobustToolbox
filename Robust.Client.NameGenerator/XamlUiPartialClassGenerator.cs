...
";
        ...
        /// </summary>
        /// <param name="diagnostics">The list of diagnostics to handle</param>
        /// <param name="context">The source generator context to report diagnostics to</param>
        /// <param name="filePath">The file to report diagnostics for.</param>
        /// <returns>Whether any diagnostics were error diagnostics</returns>
