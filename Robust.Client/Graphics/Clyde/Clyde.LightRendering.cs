...
namespace Robust.Client.Graphics.Clyde
{
    ...
    internal partial class Clyde
    {
            ...
            int zLevelOffset)
        {
            ...
            var clearColor = GetClearColor(mapUid, mapId, zLevelOffset);
        ...
        /// <inheritdoc/>
        [Pure]
        public Color GetClearColor(EntityUid mapUid, MapId mapId = default, int zLevelOffset = 0)
        {
            var clearEv = new GetClearColorEvent(mapUid, mapId, zLevelOffset);
