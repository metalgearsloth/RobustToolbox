...
/// </summary>
/// <remarks>
/// The component is runtime-only because a grid file cannot safely own an entity on another map. Full map-network
/// saves store the pairs on <see cref="ZLevelMapNetworkComponent"/> and rebuild these components after loading.
/// </remarks>
...
public sealed partial class ZLevelGridComponent : Component, IComponentDelta
{
