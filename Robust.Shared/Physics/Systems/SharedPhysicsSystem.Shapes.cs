...
public abstract partial class SharedPhysicsSystem
{
    ...
    {
        if (MathHelper.CloseTo(shape.Radius, radius) || !Resolve(uid, ref body, ref xform))
            return;
        ...
        _fixtures.FixtureUpdate(uid, body: body);
    }
        ...
        TransformComponent? xform = null)
    {
        if ((MathHelper.CloseTo(shape.Radius, radius) && shape.Position.EqualsApprox(position)) ||
            !Resolve(uid, ref body, ref xform))
            return;
    ...
    public void SetPosition(
        ...
        TransformComponent? xform = null)
    {
        if (circle.Position.EqualsApprox(position) || !Resolve(uid, ref body, ref xform))
            return;
